...
echo. 
XmlDiffView.exe /o /c /p /w "C:\Dev\git\XmlCompare\release_candidate\test\animals.xml" "C:\Dev\git\XmlCompare\release_candidate\test\animals_change.xml" "C:\Dev\git\XmlCompare\release_candidate\test\animals_changes_view.htm" "C:\Dev\git\XmlCompare\release_candidate\test\animals_diffgram.xml" "C:\Dev\git\XmlCompare\release_candidate\test\animals_ignore.xml"
...
echo. 
XmlPatch.exe "C:\Dev\git\XmlCompare\release_candidate\test\animals.xml" "C:\Dev\git\XmlCompare\release_candidate\test\animals_diffgram.xml"  "C:\Dev\git\XmlCompare\release_candidate\test\animals_with_changes_applied.xml"
echo. 
echo. 
echo All done. 
